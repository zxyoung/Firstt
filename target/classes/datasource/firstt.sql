...
-- 正在导出表  zhang.employmentinfo 的数据：~9 rows (大约)
/*!40000 ALTER TABLE `employmentinfo` DISABLE KEYS */;
INSERT INTO `employmentinfo` (`id`, `sno`, `major`, `passport`, `email`, `gowhere`, `salary`, `companyName`, `ccode`, `cproperties`, `ctrade`, `location`, `jobtitle`, `contacts`, `contactsPhone`, `cemail`) VALUES
	(1, 4141987, '网络', '610121199901017654', 'asdf@qq.com', '已经签约', 12, '公务员', 422, '私营企业', '互联网', '北京', 'IT', 'HR', '010-23423', 'Hr@BJ.com'),
	(2, 4131002, '计科', '131026199402226666', 'zxyoung94@gmial.com', '已经签约', 15, '百度', 32321, '私营企业', '互联网', '北京市', 'IT工程师', '李彦宏', '13800138', 'li@baidu.com'),
	(3, 4131004, '软工', '131026199012042364', '359176585@qq.com', '已毕业', 18, '腾讯互联网有限公司', 1244221, '私营企业', '互联网', '广东省深圳市', 'IT工程师', '马化腾', '13800138', 'ma@tencent.com'),
	(4, 4131001, '网络', '131026199203126666', '15664646679@163.com', '已经签约', 15, '西安邮电大学', 23213, '机关单位', '教育单位', '西安市', '教师', '校长是', '029-88164061', '110@xian.con'),
	(5, 4141004, '软工', '12222222222222222', 'yao@china@qq.com', '已经签约', 15, 'CN移动', 876, '国有企业', '通信', '北京', '工程技术人员', '小莉', '123321', 'sdfg@163.com'),
	(6, 4141001, '计科', '4342331', '11@qq.com', '已经签约', 18, '互联网', 4213, '私营企业', '互联网', '广州', '测试', 'HR', '3213423', 'UI@HR.com'),
	(7, 4151001, '计科', '2343532455', 'yao@china@qq.com', '已经签约', 12, 'CN移动', 876, '国有企业', '通信', '北京', '工程技术人员', '小莉', '123321', 'sdfg@163.com'),
	(8, 4151002, '网络', '610121199901017654', 'asdf@qq.com', '已经签约', 18, '公务员', 422, '私营企业', '互联网', '北京', 'IT', 'HR', '010-23423', 'Hr@BJ.com'),
	(9, 4151005, '软工', '610110199102128421', 'zhang@gmail.com', '已经签约', 12, '去哪儿', 324, '国有企业', '网络', '北京', 'Big data', '哈哈', '2321', NULL);
...
INSERT INTO `stu_account` (`id`, `sno`, `password`) VALUES
	...
	(37, 77778888, 'e10adc3949ba59abbe56e057f20f883e'),
...
-- 正在导出表  zhang.zhaopin 的数据：~8 rows (大约)
/*!40000 ALTER TABLE `zhaopin` DISABLE KEYS */;
INSERT INTO `zhaopin` (`id`, `code`, `title`, `content`, `fbtime`) VALUES
	(1, 111111, '西安公司招聘', '招聘java100人', '2017-01-18 00:00:00'),
	(4, 111111, '河北公司招聘', '招聘1000人', '2017-01-21 13:35:00'),
	(10, 12321, '网易游戏招聘', '招聘游戏开发50人', '2017-03-21 15:07:33'),
	(14, 12321, '网易招聘策划', '可以实习', '2017-03-21 00:00:00'),
	(15, 12321, '网易招聘产品经理', '要求5年工作经验', '2017-03-21 00:00:00'),
	(24, 12321, '中国太平洋财产保险股份有限公司陕西分公司', '中国太平洋财产保险股份有限公司陕西分公司成立于1993年，先后承保了青藏铁路、亚太二号C卫星、工商银行、西合铁路、绕城高速、铜黄高速、咸阳机场等重大项目，为繁荣陕西省保险市场，促进地方经济发展起到了重要的作用。招聘岗位： 岗位要求： 1.全日制大学本科及以上学历； 2.专业符合岗位要求； 3.形象气质较好，沟通能力强，有一定的创新能力； 4.能熟练运用各类办公软件', '2017-03-27 00:00:00'),
	(25, 4233, '深圳广播电影电视集团', '招聘信息： 股票分析员 任职要求： 1、本科及以上学历； 2、热爱金融行业，有强烈的意愿进入金融投资领域 3、具有良好的自我学习能力与团队合作精神； 4、具有较强的实战看盘能力，熟悉各类操盘工具； 5、耐心细致，善于观察分析；执行力强，有责任心； 6、具有很强的股票研究能力,善于进行题材挖掘能力。 工作内容： 1、负责对股票市场主流趋势，热点，主题投资策略分析； 2、建立个人模拟股票池并对相关收益进行分析； 3、分析、推荐股票，消息面汇总，建议操作方案并模拟实施； 4、按时保', '2017-03-28 16:32:54'),
	(26, 4233, '中信建投证券股份有限公司', '招聘岗位：理财规划师 （若干） 岗位职责： 1、学历要求：全日制本科及以上学历； 2、吃苦耐劳，性格开朗大方，良好的沟通表达能力； 3、较强的学习和分析能力，对市场有敏锐洞察力； 4、讲求个人信誉，恪守职业道德。 Ø 需求专业： 金融类、理工科类专业', '2017-03-30 12:45:11'),
	(27, 4233, 'zhongguo公司招聘财务人员', '1.要求：本科及以上学历；\r\n2.专业要求：专业不限，理工科优先；\r\n3.有实习经验者优先。', '2017-05-12 00:00:00');
