	...
	<div class="container">
		...
		<form action="/firstt/student/addEmploymentInfo" method="post">
			<div class="panel-body">
				...
				<div class="panel panel-default text-center">
					个人邮箱：<input name="email" type="text" value="">
				</div>
				<div class="panel panel-default text-center">
					毕业去向：<input name="gowhere" type="text" value="">
				</div>
				<div class="panel panel-default text-center">
				...
				<div class="panel panel-default text-center">
					单位性质：<input name="cproperties" type="text" value="">
				</div>
				<div class="panel panel-default text-center">
					所在行业：<input name="ctrade" type="text" value="">
				</div>
				<div class="panel panel-default text-center">
					单位地址：<input name="location" type="text" value="">
				</div>
				<div class="panel panel-default text-center">
					工作职位类别：<input name="jobtitle" type="text" value="">
				</div>
				<div class="panel panel-default text-center">
					公司联系人：<input name="contacts" type="text" value="">
				</div>
				<div class="panel panel-default text-center">
					联系人电话：<input name="contactsphone" type="tel" value="">
				</div>
				<div class="panel panel-default text-center">
					联系人邮箱：<input name="cemail" type="text" value="">
				</div>
