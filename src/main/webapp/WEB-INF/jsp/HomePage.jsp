		...
		<div class="row clearfix">
			<div class="col-md-4 column">
				...
				<p>招聘岗位：理财规划师 （若干） 岗位职责： 1、学历要求：全日制本科及以上学历；
					...
					需求专业： 金融类、理工科类专业...</p>
				<p>
					<a class="btn" href="/firstt/admin/26/noticeDetail" target="_blank">查看详情
						»</a>
				</p>
			</div>
			<div class="col-md-4 column">
				...
				<p>
					<a class="btn" href="/firstt/admin/25/noticeDetail" target="_blank">查看详情
						»</a>
				</p>
			</div>
			<div class="col-md-4 column">
				...
				<p>中国太平洋财产保险股份有限公司陕西分公司成立于1993年，先后承保了青藏铁路、亚太二号C卫星、工商银行、西合铁路、绕城高速、铜黄高速、咸阳机场等重大项目，为繁荣陕西省保险市场，促进地方经济发展起到了重要的作用。招聘岗位：
					...
					4.能熟练运用各类办公软件</p>
				<p>
					<a class="btn" href="/firstt/admin/24/noticeDetail" target="_blank">查看详情
						»</a>
				</p>
			</div>
		</div>
