...
<body>
	...
	<div
		...
		${sessionScope.stu.sno }<br /> ${stuInfo.id }
		<div align="center">
			<h2>
				<a target="display" href="/firstt/student/${stuInfo.id}/stuInfo">个人信息</a>
			</h2>
		</div>
		<div align="center">
			<h2>
				<a target="display"
					href="/firstt/student/${stuInfo.sno}/detailResume">简历</a>
			</h2>
		</div>
		<div align="center">
			<h2>
				<a target="display"
					href="/firstt/student/${stuInfo.sno}/EmploymentInfo">就业信息</a>
			</h2>
		</div>
		<div align="center">
			<h2>
				<a href="/firstt/login/stulogout">退出</a>
			</h2>
		</div>
